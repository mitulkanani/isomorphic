    ...
    },
    {
      title: (
        <HeaderCell
          ...
          sortable
          ascending={
            sortConfig?.direction === 'asc' && sortConfig?.key === 'assetID'
          }
        />
      ),
      onHeaderCell: () => onHeaderCellClick('assetID'),
      dataIndex: 'assetID',
      key: 'assetID',
      width: 180,
      render: (assetID: string, row: any) => (
        <Link
          href={routes.logistics.shipmentDetails(row.id)}
          className="duration-200 hover:text-gray-900 hover:underline"
        >
    ...
    },
    {
      title: (
        <HeaderCell
          ...
          sortable
          ascending={
            sortConfig?.direction === 'asc' && sortConfig?.key === 'serialNo'
          }
        />
      ),
      onHeaderCell: () => onHeaderCellClick('serialNo'),
      dataIndex: 'serialNo',
      key: 'serialNo',
      width: 250,
      render: (serialNo: string) => serialNo,
    },
    {
      title: (
        <HeaderCell
    ...
    },
    {
      title: (
        <HeaderCell
          ...
          sortable
          ascending={
            sortConfig?.direction === 'asc' && sortConfig?.key === 'department'
          }
        />
      ),
    ...
    },
    {
      title: (
        <HeaderCell
          ...
          sortable
          ascending={
            sortConfig?.direction === 'asc' && sortConfig?.key === 'modelNo'
          }
        />
      ),
      onHeaderCell: () => onHeaderCellClick('modelNo'),
      dataIndex: 'modelNo',
      key: 'modelNo',
      width: 250,
      render: (modelNo: string) => modelNo,
    },
    {
      title: (
        <HeaderCell
          ...
          sortable
          ascending={
            sortConfig?.direction === 'asc' && sortConfig?.key === 'remarks'
          }
        />
      ),
      onHeaderCell: () => onHeaderCellClick('remarks'),
      dataIndex: 'remarks',
      key: 'remarks',
      width: 350,
    ...
    },
    {
      title: (
        <HeaderCell
          ...
          sortable
          ascending={
            sortConfig?.direction === 'asc' && sortConfig?.key === 'assetCatego'
          }
        />
      ),
      onHeaderCell: () => onHeaderCellClick('assetCatego'),
      dataIndex: 'assetCatego',
      key: 'assetCatego',
      width: 350,
      render: (assetCatego: string) => assetCatego,
    },
    {
      title: (
        <HeaderCell
          ...
          sortable
          ascending={
            sortConfig?.direction === 'asc' && sortConfig?.key === 'OS'
          }
        />
      ),
      onHeaderCell: () => onHeaderCellClick('OS'),
      dataIndex: 'OS',
      key: 'OS',
      width: 350,
      render: (OS: string) => OS,
    },
    {
      title: (
        <HeaderCell
          ...
          sortable
          ascending={
            sortConfig?.direction === 'asc' && sortConfig?.key === 'mac_address'
          }
        />
      ),
      onHeaderCell: () => onHeaderCellClick('mac_address'),
      dataIndex: 'mac_address',
      key: 'mac_address',
      width: 350,
      render: (mac_address: string) => mac_address,
    },
    {
      title: (
        <HeaderCell
          ...
          sortable
          ascending={
            sortConfig?.direction === 'asc' && sortConfig?.key === 'IP'
          }
        />
      ),
      onHeaderCell: () => onHeaderCellClick('IP'),
      dataIndex: 'IP',
      key: 'IP',
      width: 350,
      render: (IP: string) => IP,
